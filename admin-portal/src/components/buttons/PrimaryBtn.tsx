    ...
    <>
      <button
        ...
        className={classNames(
          "flex sm:text-xs  items-center gap-2 text-center  justify-center",
          {
          ...
          "sm:px-2 sm:py-2 md:px-3 md:py-2 lg:px-2 lg:py-2 rounded-sm font-medium transition-all duration-300 ease-in-out"
        )}
        title={content}
      >
        ...
        {icon === "retry" && <RefreshCw className={`w-4 h-4 ${loadingAll ? "animate-spin" : ""}`} />}
