...
import { Field } from "../types/ApplicationDetailsType";
import {
  ApplicationStatus,
  ApplicationStatusBgColors,
  ApplicationStatusTextColors,
} from "@/constants/enums-with-colors";
import { getApplicationStatus } from "@/app/helpers/StringHelper";
      ...
      if (item.type === "form_section") {
        return {
          ...
          fields: item.pages[0].fields.map((field: Field) => ({
            ...
            // Normalize children values so child fields show correct labels/values
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={clsx(
                        ...
                        application.additional_info?.face_match_percentage >= 80
                          ? "bg-green-500"
                          : application.additional_info
                                ?.face_match_percentage >= 60
                            ? "bg-yellow-500"
                            : "bg-red-500",
                      )}
                      style={{
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-semibold text-gray-900">
                    {application.additional_info?.ocr_data.spouse_name ?? "N/A"}
                  </span>
                </div>
              </div>
