...
const FatcaQuestions = ({applicationInfo}: NIDInfoProps) => {
    
    const headings = ['Field Name', 'Value'];
    const fatcaInfo = getSectionSlug(applicationInfo, Sections.FATCA_QUENSTIONS)
    const fieldValues = getFieldLabelsAndValues(applicationInfo, Sections.FATCA_QUENSTIONS);
