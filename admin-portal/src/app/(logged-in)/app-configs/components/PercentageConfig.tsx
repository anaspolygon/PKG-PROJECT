  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="sm:text-lg lg:text-2xl font-medium">Application Config</h1>
      </div>
      ...
      {!loading && !error && percentageConfigs && (
        <>
          {percentageConfigs.length > 0 ? (
            <>
              <PercentageList configs={percentageConfigs} />
            </>
          ) : (
